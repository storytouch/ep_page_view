...
exports.postAceInit = function(hook, context){
  ...
  var pv = {
    ...
    enable: function() {
      ...
      var style = "width:641px;margin-left:-119px;height:40px;background-color:#f7f7f7;margin-top:77px;margin-bottom:77px;border-bottom:1px dotted #aaa";
...
reDrawPageBreaks = function(){
  ...
  var lines = {};
  var yHeight = 931.0; // originally was: 922.5; // This is dirty and I feel bad for it..
  var lineNumber = 0;
